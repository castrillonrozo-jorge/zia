    ...
    return (
      <div className="p-6 flex flex-col gap-8 animate-in fade-in duration-500 pb-32 pt-8">
        ...
        <div className="grid grid-cols-2 gap-4">
           ...
           >
              <div style={{ background: 'rgba(255, 255, 255, 0.12)', backdropFilter: 'blur(8px)', border: '1px solid rgba(255, 255, 255, 0.18)' }} className="w-12 h-12 rounded-2xl flex items-center justify-center chip-aurora-morado">
        ...
        <div className="grid grid-cols-1 gap-4">
          {sarenFunctions.map((fn, iCh) => (
            ...
            >
              <div style={{ background: 'rgba(255, 255, 255, 0.12)', backdropFilter: 'blur(8px)', border: '1px solid rgba(255, 255, 255, 0.18)' }} className={`w-14 h-14 rounded-2xl flex items-center justify-center shrink-0 shadow-none text-[#FFFFFF] relative z-10 chip-aurora${['','-morado','-verde','-ambar','-rojo','-teal','-rosa','-lima'][iCh % 8]}`}>
                <fn.icon size={28} />
              </div>
    ...
    return (
      <div className="p-6 flex flex-col gap-8 animate-in slide-in-from-right-4 duration-500 pb-32 pt-8">
        ...
        <div className="bg-emerald-500/[0.05] dark:bg-emerald-400/[0.08] p-8 rounded-[2.5rem] border border-emerald-500/10 dark:border-emerald-400/20 flex gap-5 backdrop-blur-xl">
           <div className="w-12 h-12 rounded-xl bg-emerald-500/10 flex items-center justify-center shrink-0 chip-aurora-verde">
        ...
        <div className="space-y-8 animate-in fade-in duration-300">
          ...
          >
            ...
            <div style={{ background: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(8px)', border: '2px dashed rgba(255, 255, 255, 0.2)' }} className="rounded-[3rem] p-16 flex flex-col items-center gap-6 hover:bg-white/10 cursor-pointer transition-all group active:scale-[0.98] relative z-10">
              <div style={{ background: 'rgba(255, 255, 255, 0.15)', backdropFilter: 'blur(8px)' }} className="w-20 h-20 rounded-3xl flex items-center justify-center group-hover:scale-110 transition-transform shadow-none text-[#FFFFFF] chip-aurora-ambar">
