      ...
      <div className="animate-in slide-in-from-right-4 duration-500 p-8 space-y-10 pt-12">
        ...
        <div className="flex flex-col items-center gap-6 py-4">
          <div className="relative">
            ...
            <label className="absolute -bottom-2 -right-2 w-12 h-12 bg-[#4F84C4] rounded-full flex items-center justify-center text-white shadow-none border-4 border-white dark:border-black active:scale-90 transition-transform cursor-pointer chip-aurora-morado">
          ...
          <div className="relative z-10 h-full flex flex-col justify-between">
            ...
            <div className="flex justify-between items-end">
              ...
              <div className="flex gap-2.5">
                <div className="bg-white/10 text-white w-10 h-10 md:w-12 md:h-12 rounded-xl flex items-center justify-center border border-white/20 backdrop-blur-md chip-aurora-verde">
                  <Icons.Plus size={16} strokeWidth={3} />
                </div>
                <div className="bg-white/10 text-white w-10 h-10 md:w-12 md:h-12 rounded-xl flex items-center justify-center border border-white/20 backdrop-blur-md chip-aurora-ambar">
          ...
          <div className="w-full max-w-sm bg-[#05070A] rounded-[3rem] overflow-hidden shadow-none animate-in zoom-in-95 duration-500 border border-white/10">
            <div className="p-8 space-y-8">
              <div className="flex justify-between items-center">
                ...
                <button onClick={() => setIsCardModalOpen(false)} style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.08)' }} className="w-10 h-10 rounded-full flex items-center justify-center chip-aurora-rojo">
            ...
            >
              <div className="flex items-center gap-5 relative z-10">
                <div 
                  ...
                  className={`w-12 h-12 rounded-xl flex items-center justify-center ${tx.type === 'in' ? 'text-emerald-300' : 'text-rose-300'} chip-aurora${['','-morado','-verde','-ambar','-rojo','-teal','-rosa','-lima'][iCh % 8]}`}
                >
